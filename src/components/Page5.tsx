...
const Page5 = () => {
  ...
  return (
    <>
      <div className="Page5 h-[160vh] max-[1024px]:h-[135vh] max-[500px]:h-[280vh] max-[400px]:h-[330vh] max-[768px]:h-[140vh] w-full flex items-center justify-center flex-col bg-[rgba(255,255,255,0.05)] p-[100px] max-[1024px]:p-[50px] max-[500px]:pl-[20px] max-[500px]:pr-[20px]">
